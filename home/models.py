...
class Contrato(models.Model):
    ...
    numero_contratante = models.CharField("Número da rua do contratante",max_length=100, blank=True, null=True)
    ...
    data_evento = models.DateField("Data do Evento",max_length=100, blank=False, null=False)
    ...
    data_pagar = models.DateField("Data a pagar", auto_now=False, auto_now_add=False, blank=False, null=False)
